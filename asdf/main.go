...
func main() {
	...
	metricsHandler.WithTags(map[string]string{"failure_reason": "WorkflowError"}).Counter("testing").Inc(1)
	metricsHandler.WithTags(map[string]string{"failure_reason": "NonDeterminismError"}).Counter("testing").Inc(1)
